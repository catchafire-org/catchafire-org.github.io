var _a;
import { c as commonjsGlobal, a as getAugmentedNamespace, g as getDefaultExportFromCjs } from "./_commonjsHelpers-ca272635.js";
import { s as setup } from "./entry-preview-7f0db4d9.js";
...
const Vue3Sanitize = /* @__PURE__ */ getDefaultExportFromCjs(vue3SanitizeExports);
const overrideSanitizeOptions = {
  allowedTags: [
    "address",
    "article",
    "aside",
...
const preview$1 = "";
setup((app) => {
  app.use(Vue3Sanitize, overrideSanitizeOptions);
});
const preview = {
  parameters: {
    controls: {
